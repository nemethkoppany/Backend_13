...
exports.PatchData = exports.PutData = exports.DeleteData = exports.InsertData = exports.getDataFromId = exports.getAllData = exports.run = void 0;
var config_1 = __importDefault(require("./config"));
var cat_1 = __importDefault(require("./cat"));
var promise_1 = __importDefault(require("mysql2/promise"));
var run = function (req, resp) {
    resp.status(200).send("A szerver fut!");
};
exports.run = run;
var getAllData = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
...
var getDataFromId = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id, connection, _a, results, err_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
...
var InsertData = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _b.trys.push([2, 4, , 5]);
                return [4 /*yield*/, connection.query('insert into cat values(null,?,?,?,?,?)', [cat.name, cat.breed, cat.gender ? 1 : 0, parseInt(cat.age), cat.picurl])];
            case 3:
                _a = __read.apply(void 0, [_b.sent(), 1]), results = _a[0];
...
var DeleteData = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_b.label) {
            ...
            case 3:
                ...
                if (results.affectedRows > 0) {
                    resp.status(201).send("Sikeresen t\u00F6r\u00F6lt ".concat(results.affectedRows, " elemet"));
                    return [2 /*return*/];
                }
                return [3 /*break*/, 5];
            case 4:
...
var PatchData = function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var id, cat, allowedFields, keys, updateString, values, sql, connection, _a, results, err_6;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = parseInt(req.params.id);
